...
output:
  xaringan::moon_reader:
    css: ["default","default-fonts","uw_slides.css"]
    lib_dir: libs
    nature:
...
include_graphics("color-center-UWlogo-print.png")
```
]
...
--
This metrics are available in [ChIPUtils](http://www.github.com/welch16/ChIPUtils)
